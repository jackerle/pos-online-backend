...
export default function MainUIRender(props) {
  ...
  return (
    <div className={classes.root}>
      <Dialog open={props.isOpen} onClose={props.onSignOffMenuClose} aria-labelledby="form-dialog-title">
        <DialogTitle id="form-dialog-title">กรุณายืนยันการออกจากระบบ</DialogTitle>
        <DialogContent>
        
        </DialogContent>
        <DialogActions>
          <Button onClick={props.onSignOff} color="primary">
            ออกจากระบบ
          </Button>
          <Button onClick={props.onSignOffMenuClose} color="primary">
            กลับไปหน้าจอขายสินค้า
          </Button>
        </DialogActions>
      </Dialog>
    </div>
